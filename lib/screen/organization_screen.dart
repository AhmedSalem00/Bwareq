...
class OrganizationScreeen extends StatelessWidget {
  const OrganizationScreeen({Key? key}) : super(key: key);
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Organization account  is  Owned  Managed by  a only one user',
                    style: TextStyle(
                      fontSize: 12,
                    ),
                  ),
